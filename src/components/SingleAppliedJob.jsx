...
const SingleAppliedJob = ({ aJob }) => {
    ...
    return (
        <div className='flex  justify-between items-center mx-auto border border-gray-500 w-full p-5 my-3 border-gray-300'>
            <div className='flex w-11/12'>
                <div className='w-48 h-48 flex justify-center items-center bg-slate-100'>
